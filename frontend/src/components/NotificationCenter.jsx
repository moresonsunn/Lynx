...
export default function NotificationCenter() {
  ...
  return (
    <div className="relative" ref={panelRef}>
      ...
      {/* Dropdown Panel */}
      {open && (
        <div className="absolute -right-2 sm:right-0 top-full mt-2 w-[calc(100vw-2rem)] sm:w-[380px] max-h-[70vh] bg-ink border border-white/10 ring-1 ring-black/30 rounded-xl shadow-2xl z-[100] flex flex-col overflow-hidden animate-fade-in origin-top-right">
          {/* Header */}
