              ...
              <div className="mt-3 flex items-center gap-2">
                {providersStatus?.curseforge?.configured ? (
                  ...
                  <>
                    ...
                    <span className="text-yellow-400 text-sm">Not configured - Get a key from <a href="https://console.curseforge.com" target="_blank" rel="noopener noreferrer" className="underline">console.curseforge.com</a></span>
                  </>
                )}
              </div>
            </Section>
