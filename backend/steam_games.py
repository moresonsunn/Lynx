...
BASE_STEAM_GAMES = {
    ...
    "rust": {
        ...
        "env": {
            "RUST_SERVER_STARTUP_ARGUMENTS": "-batchmode -load -nographics +server.ip 0.0.0.0 +server.secure 1",
            "RUST_SERVER_PORT": 28015,
            "RUST_SERVER_QUERYPORT": 28015,
        ...
        "game_settings": {
            ...
            "config_format": "keyvalue",
            "settings": [
                {"key": "server.hostname", "label": "Server Name", "type": "string", "default": "Rust Server"},
                {"key": "server.description", "label": "Description", "type": "string", "default": "Managed by Lynx"},
                {"key": "server.maxplayers", "label": "Max Players", "type": "int", "min": 1, "max": 500, "default": 50},
                {"key": "server.worldsize", "label": "World Size", "type": "int", "min": 1000, "max": 6000, "default": 2000},
                {"key": "server.seed", "label": "World Seed", "type": "int", "min": 0, "max": 2147483647, "default": 12345},
                {"key": "server.saveinterval", "label": "Save Interval (sec)", "type": "int", "min": 60, "max": 3600, "default": 600},
                {"key": "server.tickrate", "label": "Tick Rate", "type": "int", "min": 10, "max": 100, "default": 30},
                {"key": "decay.scale", "label": "Decay Scale", "type": "float", "min": 0.0, "max": 10.0, "default": 1.0},
            ],
        },
    },
    "satisfactory": {
    ...
    "vrising": {
        ...
        "game_settings": {
            "config_file": "VRisingServer_Data/StreamingAssets/Settings/ServerHostSettings.json",
            "config_format": "json",
            "settings": [
